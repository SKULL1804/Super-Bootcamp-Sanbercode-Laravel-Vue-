...
// const getRole = (id) => {
//   const role = roleStore.roles.find(role => role.id === id);
...
<template>
  <section class="pt-[4vh] space-y-2">
        ...
        <div class="card bg-base-100 w-full shadow-xl">
          <div class="card-body">
            <form @submit.prevent="handleSubmit">
              <div class="grid gap-4 sm:grid-cols-6 sm:gap-6">
                <div class="sm:col-span-3">
                  <label class="form-control w-full">
                    ...
                    <input v-model="input.age" type="text" placeholder="Age" class="input input-bordered w-full" />
                  </label>
                </div>
                <div class="sm:col-span-3">
                  <label class="form-control w-full">
              ...
              <button type="submit" class="btn text-white mt-4 sm:mt-6 text-sm bg-primary-700 rounded-lg btn-primary">
                Update
              </button>
            </form>
          </div>
