...
<template>
    <nav class="navbar justify-around relative min-h-20 xl:h-[17vh]">
        <div
            :class="['fixed top-0 left-0 right-0 navbar min-h-20 xl:h-[17vh] md:px-20 justify-around transition-all duration-300', isScrolled ? 'bg-base-100 shadow-lg z-10' : 'bg-transparent']">
            ...
            <div class="hidden xl:flex">
                <ul class="menu menu-horizontal px-1">
                    <li class="hover:text-gray-500">
                        <RouterLink to="/"
                            class="text-2xl font-medium hover:bg-inherit hover:underline underline-offset-8 decoration-gray-500 focus:bg-inherit focus:underline focus:text-gray-500 hover:focus:active:text-gray-500 hover:focus:active:bg-inherit">
                            Home</RouterLink>
                    </li>
                    <li class="hover:text-gray-500">
                        <RouterLink to="/about"
            ...
            <div class="xl:hidden flex items-center">
                <button @click="toggleMenu" class="btn btn-ghost xl:hidden">
            ...
            <div class="hidden xl:flex">
                <RouterLink to="/contact"
                    class="btn btn-ghost text-xl hover:bg-inherit hover:underline underline-offset-8 decoration-gray-500 hover:text-gray-500">
                    Contact
                    Me</RouterLink>
            </div>
        </div>
        <transition 
            ...
            enter-active-class="transition-all duration-500 delay-300 ease"
            leave-to-class="transform opacity-0 -translate-y-2"
            leave-active-class="transition-all duration-500 delay-300 ease">
