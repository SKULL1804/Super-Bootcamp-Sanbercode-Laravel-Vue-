    ...
    <div class="drawer z-10">
        ...
        <div class="drawer-content flex flex-col">
            ...
            <nav class="navbar items-center justify-between xl:px-12">
                ...
                <div class="flex items-center justify-center">
                    ...
                    <div class="hidden xl:flex">
                        <ul class="menu menu-horizontal px-1 hidden lg:flex">
                            ...
                            <li>
                                <RouterLink to="/film" class="text-xl font-medium">Film</RouterLink>
                            </li>
                            <li>
                                <RouterLink to="/cast" class="text-xl font-medium">Cast</RouterLink>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul tabindex="0"
                            ...
                            <template v-if="authStore.tokenUser">
                                <template v-if="authStore.currentUser?.email_verified_at">
                                    <li>
                                        <RouterLink to="/profile" class="text-base">
                                            Profile
                                        </RouterLink>
                                    </li>
                                    <li>
                                        <RouterLink to="/settings" class="text-base">
                                            Settings
                                        </RouterLink>
                                    </li>
                                </template>
                                <template v-else>
                                    <li>
                                        <RouterLink to="/verifikasi-akun" class="text-base">Verifikasi Akun</RouterLink>
                                    </li>
                                </template>
                                <li>
                            ...
                            <template v-else>
                                <li>
                                    <RouterLink to="/login" class="text-base">Login</RouterLink>
                                </li>
                                <li>
                                    <RouterLink to="/register" class="text-base">Register</RouterLink>
                                </li>
                            </template>
                        </ul>
                    </div>
                ...
                <div class="hidden xl:gap-2 xl:flex">
                    <RouterLink v-if="!authStore.tokenUser" to="/login" class="btn btn-ghost text-xl">Login</RouterLink>
                    <RouterLink v-if="!authStore.tokenUser" to="/register" class="btn btn-ghost text-xl">Register
                    </RouterLink>
                    <template v-else>
                        <div class="dropdown dropdown-end">
                            ...
                            <ul tabindex="0"
                                ...
                                <template v-if="authStore.currentUser?.email_verified_at">
                                    <li>
                                        <RouterLink to="/profile" class="text-base">Profile</RouterLink>
                                    </li>
                                    <li>
                                        <RouterLink to="/settings" class="text-base">
                                            Settings
        ...
        <div class="drawer-side" :class="{ 'drawer-open': isOpen }">
            ...
            <ul class="menu bg-base-200 min-h-full w-80 p-4">
                ...
                <li>
                    <RouterLink to="/" class="text-base font-medium" @click="toggleMenu">Home</RouterLink>
                </li>
                <li>
                    <details>
                ...
                <li>
                    <RouterLink to="/film" class="text-base font-medium" @click="toggleMenu">Film</RouterLink>
                </li>
                <li>
                    <RouterLink to="/cast" class="text-base font-medium" @click="toggleMenu">Cast</RouterLink>
                </li>
            </ul>
        </div>
    </div>
